...
topography_initparameters ( const char *parametersin ) {
    ...
    if ( ( fp = fopen(parametersin, "r" ) ) == NULL ) {
        fprintf( stderr,
                 "Hey man, I am at line 904, Error opening %s\n at topography_initparameters",
                 parametersin );
        return -1;
    }
    ...
    {
        fprintf( stderr,
                 " Hey man, Error parsing topography parameters from %s\n",
                 parametersin );
        // return -1;
    } else {
        fprintf(stderr, "This part is working fine \n");
    }    
...
void topo_init ( int32_t myID, const char *parametersin ) {
    ...
    if (myID == 0) {
        if ( topography_initparameters( parametersin ) != 0 ) {
            fprintf(stderr,"Thread 0001: topography_local_init: "
